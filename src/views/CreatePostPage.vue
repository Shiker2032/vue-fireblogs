...
export default {
  ...
  methods: {
    ...
    imageHandler(file, Editor, cursorLocation, resetUploader) {
      const storageRef = fireabase.storage().ref()
      const docRef = storageRef.child(`documnets/blogPostPhotos/${file.name}`)
      docRef.put(file).on(
        "state_changed",
        (snapshot) => {
        ...
        async () => {
          ...
          Editor.insertEmbed(cursorLocation, "imga", downloadURL)
          resetUploader()
        }
      )
    },
